<%@ Page language="c#" Codebehind="reActivateUser.aspx.cs" AutoEventWireup="True" Inherits="dmx.Admin.reActivateUser" %>
				...
				<tr>
					<td colspan="2"><table width="576" border="0" cellspacing="0" cellpadding="0">
							<tr valign="top">
								...
								<td width="385" bgcolor="#ffffff" class="main"><div class="title">Re-activate Employee</div>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
														...
														<td>
															<P><STRONG>Employee Type:</STRONG>
																<asp:dropdownlist id="lstEmployeeType" runat="server" AutoPostBack="True" DataTextField="strEmployeeType"
																	DataValueField="intEmployeeTypeID" OnSelectedIndexChanged="lstEmployeeType_Changed"></asp:dropdownlist></P>
															<P>De-activated Users<BR>
																<asp:ListBox id="lstEmployees" runat="server" Width="250px" Rows="8"></asp:ListBox>
																<BR>
																<asp:RequiredFieldValidator id="vldAccounts" runat="server" ErrorMessage="You must select an employee!" ControlToValidate="lstEmployees"
																	Display="Dynamic"></asp:RequiredFieldValidator>
																<asp:Label id="Message" runat="server" EnableViewState="False" Visible="False" CssClass="error"></asp:Label>
																<BR>
															</P>
														</td>
													</tr>
										...
										<tr>
											<td><table cellSpacing="0" cellPadding="0" width="340">
													...
													<tr>
														<td>
															<asp:Button id="btnActivate" runat="server" Text="Re-Activate User" OnClick="btnActivate_Click"></asp:Button></td>
														<td></td>
													</tr>
												</table>
											</td>
